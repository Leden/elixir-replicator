...
MAINTAINER Denis Lesnov <d_lesnov@wargaming.net>
...
RUN set -xe \
	...
	&& OTP_DOWNLOAD_SHA256="dbf203824bb03f2574174100ef59d80d15b3dffe33649fddaf836cd3d6ca0cde" \
...
ENV DEBIAN_FRONTEND=noninteractive PORT=4000
...
RUN apt-get update
RUN apt-get install -y git inotify-tools curl byobu gcc postgresql-client
# make gcc
